...
export declare type ClickHouseSettings = ClickHouseServerSettings & ClickHouseHTTPSettings;
...
export declare type LoadBalancing = 'random' | 'nearest_hostname' | 'in_order' | 'first_or_random' | 'round_robin';
export declare type TotalsMode = 'before_having' | 'after_having_inclusive' | 'after_having_exclusive' | 'after_having_auto';
export declare type DistributedProductMode = 'deny' | 'local' | 'global' | 'allow';
export declare type LogsLevel = 'none' | 'fatal' | 'error' | 'warning' | 'information' | 'debug' | 'trace' | 'test';
export declare type LogQueriesType = 'QUERY_START' | 'QUERY_FINISH' | 'EXCEPTION_BEFORE_START' | 'EXCEPTION_WHILE_PROCESSING';
export declare type DefaultTableEngine = 'Memory' | 'ReplicatedMergeTree' | 'ReplacingMergeTree' | 'MergeTree' | 'StripeLog' | 'ReplicatedReplacingMergeTree' | 'Log' | 'None';
export declare type MySQLDataTypesSupport = '' | 'date2String' | 'date2Date32' | 'datetime64' | 'decimal';
export declare type UnionMode = '' | 'ALL' | 'DISTINCT';
export declare type DistributedDDLOutputMode = 'never_throw' | 'null_status_on_timeout' | 'throw' | 'none';
export declare type ShortCircuitFunctionEvaluation = 'force_enable' | 'disable' | 'enable';
export declare type TransactionsWaitCSNMode = 'wait_unknown' | 'wait' | 'async';
export declare type EscapingRule = 'CSV' | 'JSON' | 'Quoted' | 'Raw' | 'XML' | 'Escaped' | 'None';
export declare type DateTimeOutputFormat = 'simple' | 'iso' | 'unix_timestamp';
export declare type EnumComparingMode = 'by_names_case_insensitive' | 'by_values' | 'by_names';
export declare type DateTimeInputFormat = 'best_effort_us' | 'best_effort' | 'basic';
export declare type MsgPackUUIDRepresentation = 'ext' | 'str' | 'bin';
export declare type OverflowMode = 'break' | 'throw';
export declare type OverflowModeGroupBy = OverflowMode | 'any';
export declare type JoinStrictness = 'ANY' | 'ALL' | '';
export declare type JoinAlgorithm = 'prefer_partial_merge' | 'hash' | 'parallel_hash' | 'partial_merge' | 'auto';
export {};
